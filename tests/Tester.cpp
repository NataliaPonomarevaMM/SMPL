 ...
 */
    void Tester::blendShape() {
        ...
        torch::Tensor poseBlendBasis = torch::from_blob(poseBlendBasis_.data(), {BATCH_SIZE, 3, POSE_BASIS_DIM}).to(m__device);
